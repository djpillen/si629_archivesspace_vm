...
if [ -d "/vagrant/aspace" ]; then
  rm -rf /vagrant/aspace
fi
mkdir /vagrant/aspace
mkdir /vagrant/aspace/zips
cd /vagrant/aspace/zips
wget -nv https://github.com/archivesspace/archivesspace/releases/download/v2.5.2/archivesspace-v2.5.2.zip
cd /vagrant/aspace
unzip /vagrant/aspace/zips/archivesspace-v2.5.2.zip
...
cd /vagrant/aspace/archivesspace/lib
...
Type=forking
RemainAfterExit=yes
ExecStart=/vagrant/aspace/archivesspace/archivesspace.sh start
ExecStop=/vagrant/aspace/archivesspace/archivesspace.sh stop
...
chown -R vagrant:vagrant /vagrant/aspace